...
$.fn.evidencing = function() {
	...
	$me.append("<div class='file-viewer upload-box' style='display: none;'><a href='#close' class='exit'><img src='/img/close-icon.png' alt='close'></a> </div>");
	...
	if(rowi > 0) {
		$(rowo).find('td:not(.nocheckbox)').each(function(coli, colo) {
	...
	$me.prepend("View step: <select id='table-nav'></select><label for='search'>&nbsp;&nbsp;or Search all steps:</label><input width=\"100px\" type=\"text\" name=\"search\" style=\"margin-top:7px\"><button id='clearSearch'>Clear </button>");
	...
	*/
	...
	$me.prepend("<a class='button file-box'>Add evidence for the selected competency statements</a>");
