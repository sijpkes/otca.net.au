...
'mbr_captcha' =>
"Submit the word you see below (if you don't see a word, make sure you check 'Yes' to the load unsecure items message when this page appears):",
...
'Your membership is already activated, try <a href=\"/member/login\" logging in</a>.',
...
'mbr_additional_otca_info' =>
"<b>Note for Practice Educators and Lecturers:</b> \nYou have been registerd as a STUDENT by default. You must contact the <a href='/partners/web-admin-list' target='_blank'>OTCA Website Administrator</a> for the university you are associated with in order to verify your identity as a Practice Educator or Lecturer.\n\n 
<a href='/partners/web-admin-list' target='_blank'>Click here for a list of OTCA Web Administrators by University</a>\n\n",
